 ...
 */
import type { ClipboardItem, ClipboardType } from '@clipboard/types'
import { ensureClipboardItemHasUuid, normalizeSyncMergedHistory } from '@clipboard/lib/cloud-sync'
