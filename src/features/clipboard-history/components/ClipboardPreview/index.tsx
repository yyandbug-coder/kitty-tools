...
import VirtualTextPreview from '@clipboard/components/VirtualTextPreview'
import { peekClipboardImagePreviewUrl, warmClipboardImagePreview } from '@clipboard/lib/clipboard-image-preview'
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-[18px]">
      ...
      >
        ...
        <Button variant="primary" size="sm" className="h-9 w-full rounded-xl" onClick={onPaste} disabled={!onPaste}>
          立即粘贴
        </Button>
      </div>
